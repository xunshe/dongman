<?php
	...
	if(!$author_avatar) {
		...
		if($result) {
			echo "<script>alert('数据保存成功！');window.location.href='/dongmanguanli/app/admin/authors.php';</script>";
		}else{
			echo "<script>alert('保存失败，请重试！');window.location.href='/dongmanguanli/app/admin/add_author.php';</script>";
		}
